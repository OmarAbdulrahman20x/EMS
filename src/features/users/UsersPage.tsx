            ...
            <>
              ...
              <div className="absolute end-0 z-20 mt-1 w-40 rounded-lg border border-gray-200 bg-white py-1 shadow-card-hover dark:border-gray-700 dark:bg-gray-800 animate-scale-in">
                <button
                  ...
                  className="flex w-full items-center gap-2 px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700/50"
                >
                ...
                {u.id !== currentUser?.id && (
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-3 py-1.5 text-sm text-error-600 hover:bg-error-50 dark:text-error-400 dark:hover:bg-error-900/20"
                  >
                    <Power size={14} />{" "}
                    {u.status === "active"
                      ? t("users.deactivate")
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            {errors.fullName && (
              <p className="mt-1 text-xs text-error-600">{errors.fullName}</p>
            )}
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              placeholder={editingUser ? t("users.passwordHint") : ""}
            />
            {errors.password && (
